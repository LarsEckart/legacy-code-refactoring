...
public final class DateTimeUtil {
	...
	public static String formatDateTimeForBulkLoader(final DateTime input) {
		...
		return dateTimeFormatter.print(input).equals(JODA_TIME_PARSED_DEFAULT_YEAR) ? DEFAULT_MIN_YEAR : dateTimeFormatter.print(input);
	}
	...
	public static String convertDateFromPatternToPattern(final String dateString, final String inputFormat, final String outputFormat) {
